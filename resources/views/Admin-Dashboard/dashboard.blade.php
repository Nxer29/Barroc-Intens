...
<script>
    ...
    new Chart(document.getElementById('rolesChart'), {
        ...
        data: {
            labels: {
                !!json_encode(array_keys($roleCounts)) !!
            },
            datasets: [{
                data: {
                    !!json_encode(array_values($roleCounts)) !!
                },
    ...
    new Chart(document.getElementById('productsChart'), {
        ...
        data: {
            labels: {
                !!json_encode($productPerCategory - > pluck('name')) !!
            },
            datasets: [{
                data: {
                    !!json_encode($productPerCategory - > pluck('products_count')) !!
                },
